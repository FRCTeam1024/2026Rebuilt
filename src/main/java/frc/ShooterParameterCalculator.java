...
public class ShooterParameterCalculator {
    ...
    public static InterpolatingTreeMap<Double, ShooterParameters> map = new InterpolatingTreeMap<>(InverseInterpolator.forDouble(), ShooterParameters::interpolate);
    ...
    public record ShooterParameters(double hoodPosition, double shooterVelocity) {
        public static ShooterParameters interpolate(ShooterParameters start, ShooterParameters end, double t) {
